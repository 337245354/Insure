...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					保单信息汇总 <i class="fa fa-user"></i><small>${devUserSession.devName}
						- 您可以在此查看所有保单信息。^_^</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<form method="post" action="getinsuredinfolist">
					<input type="hidden" name="pageIndex" value="1" />
			    <ul>
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">保险单号</label>
				...
				<div class="row">
					...
					<%--<a href="${pageContext.request.contextPath}/dev/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>--%>
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<thead>
								<tr role="row">
									<th class="sorting_asc" tabindex="0"
										...
										aria-sort="ascending">保险单号</th>
									<th class="sorting_asc" tabindex="0"
										aria-controls="datatable-responsive" rowspan="1" colspan="1"
										aria-label="First name: activate to sort column descending"
										aria-sort="ascending">购买保险人姓名</th>
							...
							<tbody>
								<c:forEach var="insuredInfo" items="${insuredInfoList}" varStatus="status">
									<tr role="row" class="odd">
										<td tabindex="0" class="sorting_1">${insuredInfo.id}</td>
										<td>${insuredInfo.buyerName }</td>
										<td>${insuredInfo.buyerID }</td>
